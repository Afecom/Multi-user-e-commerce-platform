...
import { get_seller, get_sellers, delete_seller } from "../controllers/seller.controller.js";
...
seller_router.get('/unique', validate(get_seller_schema), admin_self_user_access, get_seller);
seller_router.get('/', admin_access_control, get_sellers);
seller_router.delete('/', validate(get_seller_schema), admin_self_user_access, delete_seller);
